...
# Full disclosure! I wasn't sure of the SQLA syntax for LIKE so I Googled it
...
def get_model_info(year):
    ...
    for i in model_info:
        print i.name, i.brand.name, i.brand.headquarters
...
def get_models_between(start_year, end_year):
    ...
    models_between = Model.query.filter(Model.year >= start_year,
